--///////////////////////////////////////////////
--Name: Operation Chew A2A Defence System
...
function SEF_REDDISPATCHERON()
	...
	REDA2ADispatcher:SetDefaultTakeoffInAirAltitude(0000)
...
function SEF_REDSQUADRONSMULTIPLAYER()
    ...
    REDA2ADispatcher:SetSquadronCapInterval()
...
function SEF_REDDEFENCENETWORK()
	...
	REDDefenceNetworkGroup:FilterPrefixes( { "DF RED EWR", "RED SAM", "Qeshm Island - Mobile Radar", "Sirri Island - Navy 1", 
										   "Bandar Lengeh - Navy 1", "Havadarya - Navy 2", "Bandar-e-Jask - Navy 1", "Abu Musa - SAM 1", "Sirri Island - SAM 1", 
										   "Tunb Island - SAM 1", "Tunb Kochak - SAM 1", "Bandar Lengeh - SAM 1", "Qeshm Island - SAM 1", "Havadarya - SAM 1", 
										   "Bandar Abbas - SAM 1", "Seerik - SAM 1", "Bandar-e-Jask - SAM 1", "Minab - SAM 1", "Bandar Abbas - SAM 2" } )
